...
export const SquaresPlusIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 16.875V21m0 0h3.375m-3.375 0H10.125M18 3.75h.75a2.25 2.25 0 0 1 2.25 2.25v.75m-2.25-3h-3.375m3.375 0V7.125m-14.625 0v-3.375m0 3.375H7.125M3.75 7.125V3.75m0 3.375h-.75a2.25 2.25 0 0 0-2.25 2.25v.75m2.25-3h3.375M3.75 20.25h-.75a2.25 2.25 0 0 1-2.25-2.25v-.75m2.25 3h3.375m-3.375 0V16.875m14.625 0v3.375m0-3.375H16.875M20.25 16.875v3.375h.75a2.25 2.25 0 0 0 2.25-2.25v-.75m-2.25 3h-3.375M10.5 3.75h3.375M10.5 20.25h3.375" />
  </svg>
);
...
// ÍCONE ADICIONADO PARA A ABA NOVELA
export const RocketLaunchIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 0 0 6.16-12.12A14.98 14.98 0 0 0 9.63 8.41m5.96 5.96a14.96 14.96 0 0 1-10.58 4.39L3 21l.88-5.555A14.95 14.95 0 0 1 8.27 4.87C8.27 4.87 8.73 4.41 9.63 4.41a14.96 14.96 0 0 1 5.96 5.96Zm0 0L21 3.75M9.15 12a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Z" />
  </svg>
);
